...
public class WorkerChatBotSslBuilder {
    ...
    public WorkerChatBotSslBuilder setMaxConcurrentActivityExecutionSize(int maxConcurrentActivityExecutionSize) {
        this.maxConcurrentActivityExecutionSize = maxConcurrentActivityExecutionSize;
        return this;
    }

    public WorkerChatBotSslBuilder setMaxConcurrentLocalActivityExecutionSize(int maxConcurrentLocalActivityExecutionSize) {
        this.maxConcurrentLocalActivityExecutionSize = maxConcurrentLocalActivityExecutionSize;
        return this;
    }

    public WorkerChatBotSslBuilder setMaxConcurrentWorkflowTaskExecutionSize(int maxConcurrentWorkflowTaskExecutionSize) {
    ...
    public WorkerChatBotSsl createWorkerChatBotSsl() {
        return new WorkerChatBotSsl(workflowCacheSize,
