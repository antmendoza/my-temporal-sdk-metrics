...
package com.antmendoza.temporal.sinch._2;

import com.antmendoza.temporal.sinch.ChatBot;
import com.antmendoza.temporal.sinch.ServiceFactory;
import com.antmendoza.temporal.sinch.worker.WorkerChatBotSslBuilder;
...
public class StarterAutometedExample {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        new WorkerChatBotSslBuilder()
                ...
                .createWorkerChatBotSsl().start(service);
        ...
        do {
            ...
            executionsOpenWofkflowsCount = client
                    .getWorkflowServiceStubs()
                    .blockingStub()
                    .listOpenWorkflowExecutions(ListOpenWorkflowExecutionsRequest.newBuilder().setNamespace(ServiceFactory.getNamespace()).build()).getExecutionsCount();
